...
from artemis_mudri.simulation.v1 import vehicle_simulation_pb2 as artemis__mudri_dot_simulation_dot_v1_dot_vehicle__simulation__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in artemis_mudri/simulation/v1/vehicle_simulation_pb2_grpc.py depends on'
