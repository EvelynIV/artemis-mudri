...
from artemis_mudri.domains.track import ARC_LINE_WIDTH_M, OFFICIAL_ARCS
...
class LineSensorArray:
    ...
    @property
    def local_sensor_positions(self) -> FloatArray:
        """返回传感器在车体系下的位置。"""
        return self._local_sensor_positions.copy()

    def darkness_at(self, point: FloatArray) -> float:
        """计算某一点落在线上的“黑度”。"""
        max_darkness = 0.0
